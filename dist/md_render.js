...
function markup(rawTxt) {
    const replaceMarkdown = (text, markdown, htmlTag) => {
...
function md2html(md_text, contentBody) {
...
function header(contentBody, lineManager) {
...
function table(contentBody, lineManager) {
...
function paragraph(contentBody, lineManager, textString) {
    let textList = [];
    if (textString != "") {
...
(function (LineType) {
    ...
    LineType[LineType["PARAGRAPH"] = 1] = "PARAGRAPH";
    LineType[LineType["ITEMIZE"] = 2] = "ITEMIZE";
    LineType[LineType["ENUMERATE"] = 3] = "ENUMERATE";
    LineType[LineType["BLANKLINE"] = 4] = "BLANKLINE";
    LineType[LineType["TABLE_BORDER"] = 5] = "TABLE_BORDER";
    LineType[LineType["TABLE_CONTENT"] = 6] = "TABLE_CONTENT";
    LineType[LineType["IMAGE"] = 7] = "IMAGE";
...
function itemize(contentBody, lineManager, parentNestLevel) {
    const checkboxHtml = (text) => {
...
function enumerate(contentBody, lineManager, parentNestLevel) {
...
function imageBlock(contentBody, lineManager) {
...
function horizonalLine(contentBody, lineManager) {
